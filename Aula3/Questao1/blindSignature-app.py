...
def parseArgs():
    ...
    if(len(sys.argv) == 5 and sys.argv[1] == "-key" and sys.argv[3] == "-bmsg"):
        ...
        blindMess = sys.argv[4]
        main(eccPrivateKeyPath, blindMess)
    else:
        printUsage()
...
def main(eccPrivateKeyPath,blindMess):
    ...
    errorCode, blindSignature = eccblind.generateBlindSignature(pemKey, passphrase, blindMess, initComponents)
